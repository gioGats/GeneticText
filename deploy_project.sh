...
find ~/PycharmProjects/GeneticText/ -name '.DS_Store' -type f -delete

# Copy relevant programs to deep learning servers
#rsync -r -u ~/PycharmProjects/GeneticText rgio@cobalt.centurion.ai:/centurion/



#rsync -r -u ~/PycharmProjects/FREDcast rgio@10.0.1.14:/centurion/

rsync -r ~/PycharmProjects/GeneticText rgio@buff.centurion.ai:/centurion/
